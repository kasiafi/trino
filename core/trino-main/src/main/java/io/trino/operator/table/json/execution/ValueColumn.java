    ...
    implements Column
{
    ...
    public ValueColumn(int outputIndex, MethodHandle methodHandle, int emptyDefaultInput, int errorDefaultInput)
    {
    ...
    {
        // get the defaults from page at position if present (i.e. channels != -1)
        // call the handle for (item, emptyDefault, errorDefault)
