...
relationPrimary
    ...
    | JSON_TABLE '('
        ...
        | PLAN DEFAULT '(' jsonTablePlanDefault ')')?
...
compositePlan
    : leafPlan (OUTER | INNER) planPrimary                      #planParentChild
    | planPrimary UNION planPrimary (UNION planPrimary)*        #planSiblingsUnion
    | planPrimary CROSS planPrimary (CROSS planPrimary)*        #planSiblingsCross
    ;
