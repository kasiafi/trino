...
{
    private final TypeSiblings type;
    private final List<JsonTableSpecificPlan> siblings;

    public PlanSiblings(NodeLocation location, TypeSiblings type, List<JsonTableSpecificPlan> siblings)
    {
        super(location);
