...
{
    private final TypeParentChild parentChild;
    private final TypeSiblings siblings;

    public JsonTableDefaultPlan(NodeLocation location, TypeParentChild typeParentChild, TypeSiblings typeSiblings)
    {
        super(location);
        this.parentChild = requireNonNull(typeParentChild, "parentChild is null");
        this.siblings = requireNonNull(typeSiblings, "siblings is null");
    }

    public TypeParentChild getParentChild()
    {
        return parentChild;
    }

    public TypeSiblings getSiblings()
    {
        return siblings;
    }
