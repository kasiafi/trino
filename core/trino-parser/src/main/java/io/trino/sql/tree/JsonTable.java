        ...
        extends Relation
{
    ...
    public JsonTable(NodeLocation location, JsonPathInvocation jsonPathInvocation, List<JsonTableColumn> columns, Optional<JsonTablePlan> plan, Optional<ErrorBehavior> errorBehavior)
    {
