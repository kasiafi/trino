...
{
    private final TypeParentChild type;
    private final PlanLeaf parent;
    private final JsonTableSpecificPlan child;

    public PlanParentChild(NodeLocation location, TypeParentChild type, PlanLeaf parent, JsonTableSpecificPlan child)
    {
        super(location);
    ...
    public TypeParentChild getType()
    {
        return type;
    }
